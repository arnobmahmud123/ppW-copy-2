  ...
  const fetchWorkOrders = async () => {
    try {
      ...
      if (response.ok) {
        ...
        const processorWorkOrders = data.filter((order: WorkOrder) => 
          order.assignedProcessorId === session?.user?.id
        )
        setWorkOrders(processorWorkOrders)
    ...
    <div className="space-y-6">
      ...
      <div className="bg-white shadow rounded-lg p-6">
        ...
        <p className="text-gray-600 mt-1">
          Processor Dashboard - Manage your assigned work orders
        </p>
      </div>
      ...
      <div className="bg-white shadow rounded-lg">
        <div className="px-6 py-4 border-b border-gray-200">
          ...
          <p className="text-sm text-gray-600 mt-1">
            Work orders assigned to you for processing
          </p>
        </div>
                    ...
                    <tr key={order.id} className="hover:bg-gray-50">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                        <div>
                          ...
                          {order.assignedCoordinator && (
                            <div>Coordinator: {order.assignedCoordinator.name}</div>
                          )}
                          {!order.assignedContractor && !order.assignedCoordinator && (
                      ...
                      <td className="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <Link
                          href={`/dashboard/processor/work-orders/${order.id}`}
